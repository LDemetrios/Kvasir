...
public class TypstParenthesizedElementImpl extends ASTWrapperPsiElement implements TypstParenthesizedElement {

  public TypstParenthesizedElementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public TypstEntry getEntry() {
    return findChildByClass(TypstEntry.class);
  }

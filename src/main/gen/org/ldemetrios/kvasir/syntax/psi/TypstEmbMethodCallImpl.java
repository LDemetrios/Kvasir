...
public class TypstEmbMethodCallImpl extends TypstMethodCallImpl implements TypstEmbMethodCall {

  public TypstEmbMethodCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TypstVisitor visitor) {
    visitor.visitEmbMethodCall(this);
  }

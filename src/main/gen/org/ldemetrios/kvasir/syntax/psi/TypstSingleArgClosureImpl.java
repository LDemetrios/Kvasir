...
public class TypstSingleArgClosureImpl extends ASTWrapperPsiElement implements TypstSingleArgClosure {

  public TypstSingleArgClosureImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TypstVisitor visitor) {
    visitor.visitSingleArgClosure(this);
  }

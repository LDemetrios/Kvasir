...
public class TypstUnequalsExprImpl extends TypstBinaryExprImpl implements TypstUnequalsExpr {

  public TypstUnequalsExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TypstVisitor visitor) {
    visitor.visitUnequalsExpr(this);
  }

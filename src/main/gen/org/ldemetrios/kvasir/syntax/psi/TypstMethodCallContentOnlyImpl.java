...
public class TypstMethodCallContentOnlyImpl extends ASTWrapperPsiElement implements TypstMethodCallContentOnly {

  public TypstMethodCallContentOnlyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TypstVisitor visitor) {
    visitor.visitMethodCallContentOnly(this);
  }

...
public class TypstFunctionCallRegularImpl extends ASTWrapperPsiElement implements TypstFunctionCallRegular {

  public TypstFunctionCallRegularImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TypstVisitor visitor) {
    visitor.visitFunctionCallRegular(this);
  }

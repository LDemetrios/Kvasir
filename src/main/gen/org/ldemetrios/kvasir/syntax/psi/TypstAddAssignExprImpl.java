...
public class TypstAddAssignExprImpl extends TypstBinaryExprImpl implements TypstAddAssignExpr {

  public TypstAddAssignExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull TypstVisitor visitor) {
    visitor.visitAddAssignExpr(this);
  }

...
public class TypstLetStmtImpl extends ASTWrapperPsiElement implements TypstLetStmt {

  public TypstLetStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public TypstLetBinding getLetBinding() {
    return findChildByClass(TypstLetBinding.class);
  }

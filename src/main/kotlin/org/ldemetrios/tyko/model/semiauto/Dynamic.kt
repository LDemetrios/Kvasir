...
public interface TDynamic : TValue, DynamicEnum, TEmptyDictionary, TSetBibliography, TBibliography,
        TSetList, TList, TListItem, TSetCite, TCite, TSetDocument, TDocument, TEmph, TSetFigure,
        TFigure, TSetCaption, TCaption, TSetFootnote, TFootnote, TSetFootnoteEntry, TFootnoteEntry,
        TSetHeading, THeading, TLink, TSetEnum, TEnum, TSetEnumItem, TEnumItem, TSetOutline, TOutline,
        TSetPar, TPar, TSetParLine, TParLine, TParbreak, TSetQuote, TQuote, TSetRef, TRef, TSetStrong,
        TStrong, TSetTable, TTable, TSetTableCell, TTableCell, TSetTableHline, TTableHline,
        TSetTableVline, TTableVline, TSetTableHeader, TTableHeader, TSetTableFooter, TTableFooter,
        TSetTerms, TTerms, TTermsItem, TSetHighlight, THighlight, TSetLinebreak, TLinebreak,
        TSetOverline, TOverline, TSetRaw, TRaw, TRawLine, TSetSmallcaps, TSmallcaps, TSetSmartquote,
        TSmartquote, TSetStrike, TStrike, TSetSub, TSub, TSetSuper, TSuper, TSetText, TText,
        TSetUnderline, TUnderline, TSetMathAccent, TMathAccent, TMathBinom, TSetMathCancel, TMathCancel,
        TSetMathCases, TMathCases, TMathClass, TSetMathEquation, TMathEquation, TMathFrac, TSetMathMat,
        TMathMat, TMathPrimes, TSetMathStretch, TMathStretch, TSetMathOp, TMathOp, TSetMathVec,
        TMathVec, TSetAlign, TAlign, TSetBlock, TBlock, TSetBox, TBox, TSetColbreak, TColbreak,
        TSetColumns, TColumns, TSetGrid, TGrid, TSetGridCell, TGridCell, TSetGridHline, TGridHline,
        TSetGridVline, TGridVline, TSetGridHeader, TGridHeader, TSetGridFooter, TGridFooter, THide,
        TSetMove, TMove, TSetPad, TPad, TSetPage, TPage, TSetPagebreak, TPagebreak, TSetPlace, TPlace,
        TFlush, TSetRepeat, TRepeat, TSetRotate, TRotate, TSetScale, TScale, TSetSkew, TSkew, TSetH, TH,
        TSetV, TV, TSetStack, TStack, TSetCircle, TCircle, TSetEllipse, TEllipse, TSetImage, TImage,
        TSetLine, TLine, TSetPath, TPath, TSetPolygon, TPolygon, TSetRect, TRect, TSetSquare, TSquare,
        ...
        TSequence, TSpace, TFunction, TClosure, TWith, TNativeFunc, TShowRule, TContext,

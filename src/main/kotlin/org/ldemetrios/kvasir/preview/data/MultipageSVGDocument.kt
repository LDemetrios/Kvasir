...
class SVGPage(val file: String, val loader: SVGLoader, createHard: Boolean = true) {
...
class MultipageSVGDocument(val folder: List<String>, val pageGap: Double) {
    val loader = SVGLoader()

    val pages = folder.map { SVGPage(it, loader) }
    val size = pages.size

...
//
//fun customizeScrollBar(scrollPane: JScrollPane) {
//    scrollPane.verticalScrollBar.ui = object : BasicScrollBarUI() {
//        override fun configureScrollBarColors() {
//            thumbColor = UIManager.getColor("ScrollBar.thumb")
//            trackColor = UIManager.getColor("ScrollBar.track")
//            thumbDarkShadowColor = UIManager.getColor("ScrollBar.darkShadow")
//            thumbHighlightColor = UIManager.getColor("ScrollBar.highlight")
//            trackHighlightColor = UIManager.getColor("ScrollBar.trackHighlight")
//        }
//    }
//    // Apply similar customization to horizontal scrollbar if needed
//}

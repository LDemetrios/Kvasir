...
- Kvasir теперь чисто JVM-проект, никаких нативных зависимостей, никаких ОС-процессов, он кросс-платформенный из коробки.
- Добавлена настройка для отключения компиляции.
- Появился экспериментальный API для интероперабельности с JVM (в частности, `.jar` плагины). По умолчанию отключён.
- Баг, при котором `inputs` не менялись без перезагрузки IDE или плагина, исправлен.
- Добавлена настройка для регулирования кэша между компиляциями.
